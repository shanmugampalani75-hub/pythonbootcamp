...
app = FastAPI(tittle="SQLite Database API", version="1.0.0")
    ...
    try:
        ...
        if user_id:
            ...
            raise HTTPException(
                ...
                detail="Failed to create user. Email might already exists." 
            )
    except Exception as e:
        raise HTTPException(
            status_code=status.HTTTP_500_INTERNAL_SERVER_ERROR,
